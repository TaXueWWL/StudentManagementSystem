...
<body>
	<jsp:include page="header-admin-login.html"></jsp:include>
		...
		<div class="col-md-12">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<center>
						<img align="center" src="images/github-logo.jpg">
					</center>
					<center>
						<p>
						<ol>
							...
							<li><h3>
									<font color="red">管理员权限为增删改查.</font>
								</h3></li>
							<li><h3>
									<font color="red">管理员账号由系统维护者给出,未经允许禁止增加.</font>
								</h3></li>
							<li><h3>
									<font color="red">本系统仅做成绩查询之用,所有数据已人工备份.</font>
								</h3></li>
						</ol>
